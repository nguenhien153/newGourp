 ...
 */
package sem4.jee.g01jewelap.web.client.contact;
...
public class ContactSendServlet extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(ContactSendServlet.class.getName());
